...
//								$('<a href="#" class="selecteee">aaa</a>'),
								...
								$('<div class="dp-nav-prev"></div>')
									.append(
										...
										$('<a class="dp-nav-prev-month" href="#" title="' + $.dpText.TEXT_PREV_MONTH + '"><i class="icon-chevron-left"></i></a>')
											.bind(
												'click',
												function()
												{
								...
								$('<div class="dp-nav-next"></div>')
									.append(
										...
										$('<a class="dp-nav-next-month" href="#" title="' + $.dpText.TEXT_NEXT_MONTH + '"><i class="icon-chevron-right"></i></a>')
											.bind(
												'click',
												function()
												{
...
//					$('.selectee', this.context).focus();
			...
			_renderCalendar : function()
			{
				...
				if (this.displayedYear == this.startDate.getFullYear() && this.displayedMonth == this.startDate.getMonth()) {
					...
					$('i.icon-chevron-left').addClass('icon-white');
					...
					$('i.icon-chevron-left').removeClass('icon-white');
					var d = this.startDate.getDate();
					if (d > 20) {
